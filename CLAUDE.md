# Family Zoo — v15 — Timed Events (Daemons & Fuses) — Claude Project Memory
...
**Name:** Family Zoo — v15 — Timed Events (Daemons & Fuses)
**Purpose:** Sharpee tutorial step 15 — Timed Events (Daemons & Fuses).
...
**Repository:** https://github.com/Johnesco/familyzoo-v15
**Live:** https://johnesco.github.io/familyzoo-v15/
...
├── familyzoo-15.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v15.story`.
